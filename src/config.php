...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'KKi3k4jtytiMCJuL', // Random key for encryption
    "ENCRYPTION_KEY" => '', // Encryption key for data protection
    "PROJECT_STYLESHEET_FILENAME" => "css/demo2023.css", // Project stylesheet file name
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => true,
                "adapter" => 'PHPMaker2023\\demo2023\\AzureAD',
                "keys" => [
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2023\\demo2023\\Saml2',
    ...
    "UPLOAD_ALLOWED_FILE_EXT" => "gif,jpg,jpeg,bmp,png,doc,xls,pdf,zip", // Allowed file extensions
