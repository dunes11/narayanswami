...
class OrdersByProduct extends DbTable
{
    ...
    {
        global $Language;
        if ($pageName == "ordersbyproductview") {
            return $Language->phrase("View");
        } elseif ($pageName == "ordersbyproductedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ordersbyproductadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "OrdersByProductView";
            case Config("API_ADD_ACTION"):
                return "OrdersByProductAdd";
            case Config("API_EDIT_ACTION"):
                return "OrdersByProductEdit";
            case Config("API_DELETE_ACTION"):
                return "OrdersByProductDelete";
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ordersbyproductdelete");
        }
    }
