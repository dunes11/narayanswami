...
class SalesByCustomer2 extends ReportTable
{
    ...
    public function __construct()
    {
        ...
        $this->OrderID->addMethod("getSearchDefault", fn() => Config("INIT_VALUE"));
        ...
        $this->OrderID->Lookup = new Lookup('OrderID', 'order_details_extended_2', true, 'OrderID', ["OrderID","","",""], '', '', [], [], [], [], [], [], '`OrderID` ASC', '', "`OrderID`");
        $this->OrderID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->OrderID->SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->OrderID->AdvancedSearch->SearchValueDefault = $this->OrderID->getSearchDefault();
