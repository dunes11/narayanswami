...
class ProductsByCategory2 extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->Discontinued->Lookup = new Lookup('Discontinued', 'products_by_category2', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
    ...
    {
        global $Language;
        if ($pageName == "productsbycategory2view") {
            return $Language->phrase("View");
        } elseif ($pageName == "productsbycategory2edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "productsbycategory2add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ProductsByCategory2View";
            case Config("API_ADD_ACTION"):
                return "ProductsByCategory2Add";
            case Config("API_EDIT_ACTION"):
                return "ProductsByCategory2Edit";
            case Config("API_DELETE_ACTION"):
                return "ProductsByCategory2Delete";
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("productsbycategory2delete");
        }
    }
