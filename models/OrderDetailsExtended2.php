...
class OrderDetailsExtended2 extends DbTable
{
    ...
    {
        global $Language;
        if ($pageName == "orderdetailsextended2view") {
            return $Language->phrase("View");
        } elseif ($pageName == "orderdetailsextended2edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "orderdetailsextended2add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "OrderDetailsExtended2View";
            case Config("API_ADD_ACTION"):
                return "OrderDetailsExtended2Add";
            case Config("API_EDIT_ACTION"):
                return "OrderDetailsExtended2Edit";
            case Config("API_DELETE_ACTION"):
                return "OrderDetailsExtended2Delete";
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("orderdetailsextended2delete");
        }
    }
