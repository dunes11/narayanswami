        ...
        if ($rs = $this->loadRecordset()) {
            ...
            while (!$rs->EOF) {
                if ($i == 1) {
                    ...
                    if (!CompareValue($this->SupplierID->DbValue, $rs->fields['SupplierID'])) {
                        $this->SupplierID->CurrentValue = null;
                    }
                    if (!CompareValue($this->CompanyName->DbValue, $rs->fields['CompanyName'])) {
                        $this->CompanyName->CurrentValue = null;
                    }
                    if (!CompareValue($this->ContactName->DbValue, $rs->fields['ContactName'])) {
                        $this->ContactName->CurrentValue = null;
                    }
                    if (!CompareValue($this->ContactTitle->DbValue, $rs->fields['ContactTitle'])) {
                    ...
                    if (!CompareValue($this->Region->DbValue, $rs->fields['Region'])) {
                        $this->Region->CurrentValue = null;
                    }
                    if (!CompareValue($this->PostalCode->DbValue, $rs->fields['PostalCode'])) {
                        $this->PostalCode->CurrentValue = null;
                    }
                    if (!CompareValue($this->Country->DbValue, $rs->fields['Country'])) {
                    ...
                    if (!CompareValue($this->HomePage->DbValue, $rs->fields['HomePage'])) {
