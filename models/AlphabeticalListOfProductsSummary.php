...
class AlphabeticalListOfProductsSummary extends AlphabeticalListOfProducts
{
    ...
    public function __construct()
    {
        ...
        if (!isset($GLOBALS["Alphabetical_List_of_Products"]) || get_class($GLOBALS["Alphabetical_List_of_Products"]) == PROJECT_NAMESPACE . "Alphabetical_List_of_Products") {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_TOTAL && $this->RowTotalSubType == ROWTOTAL_FOOTER && $this->RowTotalType == ROWTOTAL_PAGE) {
            ...
            $this->UnitsInStock->getSum($records);
            ...
            if (!$hasCount || !$hasSummary) {
                ...
                $this->UnitsInStock->getSum($this->DetailRecords);
            }
        }
        ...
        if ($this->RowType == ROWTYPE_SEARCH) { // Search row
            ...
            $this->UnitsInStock->CellAttrs["class"] = ($this->RowTotalType == ROWTOTAL_PAGE || $this->RowTotalType == ROWTOTAL_GRAND) ? "ew-rpt-grp-aggregate" : "ew-rpt-grp-summary-" . $this->RowGroupLevel;
