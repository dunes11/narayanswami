        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($this->SupplierID->AdvancedSearch->ViewValue !== null) { // Load from cache
                ...
                if ($curVal == "") {
                    ...
                    $filterWrk = SearchFilter("`SupplierID`", "=", $this->SupplierID->AdvancedSearch->SearchValue, DATATYPE_NUMBER, "");
                }
            ...
            if ($this->CategoryID->AdvancedSearch->ViewValue !== null) { // Load from cache
                ...
                if ($curVal == "") {
                    ...
                    $filterWrk = SearchFilter("`CategoryID`", "=", $this->CategoryID->AdvancedSearch->SearchValue, DATATYPE_NUMBER, "");
                }
