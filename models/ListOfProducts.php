...
class ListOfProducts extends DbTable
{
    ...
    {
        global $Language;
        if ($pageName == "listofproductsview") {
            return $Language->phrase("View");
        } elseif ($pageName == "listofproductsedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "listofproductsadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "ListOfProductsAdd";
            case Config("API_EDIT_ACTION"):
                return "ListOfProductsEdit";
            case Config("API_DELETE_ACTION"):
                return "ListOfProductsDelete";
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("listofproductsdelete");
        }
    }
