...
class Orders2 extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->CustomerID->Lookup = new Lookup('CustomerID', 'customers', false, 'CustomerID', ["CompanyName","","",""], '', '', [], [], [], [], [], [], '', '', "`CompanyName`");
        ...
        $this->FreightByEmployees->setParameter("alpha", "50"); // Chart alpha
        $this->FreightByEmployees->setParameter("colorpalette", "#5899DA,#E8743B,#19A979,#ED4A7B,#945ECF,#13A4B4,#525DF4,#BF399E,#6C8893,#EE6868,#2F6497"); // Chart color palette
    ...
    {
        global $Language;
        if ($pageName == "orders2view") {
            return $Language->phrase("View");
        } elseif ($pageName == "orders2edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "orders2add") {
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("orders2delete");
        }
    }
