...
class Models extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->Trademark->Lookup = new Lookup('Trademark', 'trademarks', false, 'ID', ["Trademark","","",""], '', '', [], [], [], [], [], [], '', '', "`Trademark`");
    ...
    {
        global $Language;
        if ($pageName == "modelsview") {
            return $Language->phrase("View");
        } elseif ($pageName == "modelsedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "modelsadd") {
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("modelsdelete");
        }
    }
