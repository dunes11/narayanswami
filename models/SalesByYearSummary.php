...
class SalesByYearSummary extends SalesByYear
{
    ...
    public function __construct()
    {
        ...
        if (!isset($GLOBALS["Sales_By_Year"]) || get_class($GLOBALS["Sales_By_Year"]) == PROJECT_NAMESPACE . "Sales_By_Year") {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_TOTAL && $this->RowTotalSubType == ROWTOTAL_FOOTER && $this->RowTotalType == ROWTOTAL_PAGE) {
            ...
            if (!$hasCount || !$hasSummary) {
                ...
                $this->Subtotal->getSum($this->DetailRecords);
            }
        }
        ...
        if ($this->RowType == ROWTYPE_SEARCH) { // Search row
            ...
            $this->Subtotal->CellAttrs["class"] = ($this->RowTotalType == ROWTOTAL_PAGE || $this->RowTotalType == ROWTOTAL_GRAND) ? "ew-rpt-grp-aggregate" : "ew-rpt-grp-summary-" . $this->RowGroupLevel;
