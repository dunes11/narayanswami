...
class EmployeeSalesByCountryFor2014 extends DbTable
{
    ...
    {
        global $Language;
        if ($pageName == "employeesalesbycountryfor2014view") {
            return $Language->phrase("View");
        } elseif ($pageName == "employeesalesbycountryfor2014edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "employeesalesbycountryfor2014add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "EmployeeSalesByCountryFor2014View";
            case Config("API_ADD_ACTION"):
                return "EmployeeSalesByCountryFor2014Add";
            case Config("API_EDIT_ACTION"):
                return "EmployeeSalesByCountryFor2014Edit";
            case Config("API_DELETE_ACTION"):
                return "EmployeeSalesByCountryFor2014Delete";
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("employeesalesbycountryfor2014delete");
        }
    }
