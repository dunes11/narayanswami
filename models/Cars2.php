...
class Cars2 extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->Model->Lookup = new Lookup('Model', 'models', false, 'ID', ["Model","","",""], '', '', ["x_Trademark"], [], ["Trademark"], ["x_Trademark"], [], [], '', '', "`Model`");
        ...
        $this->TransmissAutomatic->Lookup = new Lookup('TransmissAutomatic', 'cars2', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
    ...
    public function getSqlSelectList() // Select for List page
    {
        ...
        $from = "(SELECT *, (SELECT `Trademark` FROM trademarks TMP_LOOKUPTABLE WHERE TMP_LOOKUPTABLE.ID = cars2.Trademark LIMIT 1) AS EV__Trademark, (SELECT `Model` FROM models TMP_LOOKUPTABLE WHERE TMP_LOOKUPTABLE.ID = cars2.Model LIMIT 1) AS EV__Model FROM cars2)";
    ...
    {
        global $Language;
        if ($pageName == "cars2view") {
            return $Language->phrase("View");
        } elseif ($pageName == "cars2edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "cars2add") {
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("cars2delete");
        }
    }
    ...
    public function renderListRow()
    {
        ...
        if (!$this->isExport()) {
            ...
            $this->Model->LinkAttrs["data-tooltip-id"] = "tt_cars2_x" . (($this->RowType != ROWTYPE_MASTER) ? @$this->RowCount : "") . "_Model";
