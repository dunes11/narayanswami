...
class SalesByOrderSummary extends SalesByOrder
{
    ...
    public function __construct()
    {
        ...
        if (!isset($GLOBALS["Sales_By_Order"]) || get_class($GLOBALS["Sales_By_Order"]) == PROJECT_NAMESPACE . "Sales_By_Order") {
    ...
    protected function getExtendedFilter()
    {
        ...
        if (Get("cmd") == "reset") {
            ...
            if ($this->CompanyName->DataType == DATATYPE_DATE) { // Format default date format
