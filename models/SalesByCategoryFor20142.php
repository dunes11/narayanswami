...
class SalesByCategoryFor20142 extends DbTable
{
    ...
    {
        global $Language;
        if ($pageName == "salesbycategoryfor20142view") {
            return $Language->phrase("View");
        } elseif ($pageName == "salesbycategoryfor20142edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "salesbycategoryfor20142add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "SalesByCategoryFor20142View";
            case Config("API_ADD_ACTION"):
                return "SalesByCategoryFor20142Add";
            case Config("API_EDIT_ACTION"):
                return "SalesByCategoryFor20142Edit";
            case Config("API_DELETE_ACTION"):
                return "SalesByCategoryFor20142Delete";
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("salesbycategoryfor20142delete");
        }
    }
