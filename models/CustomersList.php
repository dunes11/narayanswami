...
class CustomersList extends Customers
{
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("Region", $this->createColumnOption("Region"));
            $option->add("PostalCode", $this->createColumnOption("PostalCode"));
            $option->add("Country", $this->createColumnOption("Country"));
            $option->add("Phone", $this->createColumnOption("Phone"));
            $option->add("Fax", $this->createColumnOption("Fax"));
        }
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_customers", "data-rowtype" => ROWTYPE_ADD]);
