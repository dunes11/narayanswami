...
class OrdersByProduct2 extends ReportTable
{
    ...
    public function __construct()
    {
        ...
        $this->OrderByProducts->setParameter("alpha", "50"); // Chart alpha
        $this->OrderByProducts->setParameter("colorpalette", "#5899DA,#E8743B,#19A979,#ED4A7B,#945ECF,#13A4B4,#525DF4,#BF399E,#6C8893,#EE6868,#2F6497"); // Chart color palette
        $this->OrderByProducts->setParameters([["annotation1.show",true],["annotation1.startValue",100000],["annotation1.endValue",100000],["annotation1.displayValue","Popular"],["options.plugins.tooltip.enabled",true],["options.plugins.tooltip.mode","point"]]);
