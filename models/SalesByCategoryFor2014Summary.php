...
class SalesByCategoryFor2014Summary extends SalesByCategoryFor2014
{
    ...
    public function __construct()
    {
        ...
        if (!isset($GLOBALS["Sales_by_Category_for_2014"]) || get_class($GLOBALS["Sales_by_Category_for_2014"]) == PROJECT_NAMESPACE . "Sales_by_Category_for_2014") {
        ...
        if ($this->RowType == ROWTYPE_SEARCH) {
            ...
            if ($this->CategoryName->AdvancedSearch->ViewValue !== null) { // Load from cache
                ...
                if ($curVal == "") {
                    ...
                    $filterWrk = SearchFilter("`CategoryName`", "=", $this->CategoryName->AdvancedSearch->SearchValue, DATATYPE_STRING, "");
                }
    ...
    public function getFilterList()
    {
        ...
        // Field CategoryName
        $wrk = "";
        $wrk = ($this->CategoryName->AdvancedSearch->SearchValue != Config("INIT_VALUE")) ? $this->CategoryName->AdvancedSearch->SearchValue : "";
        if (is_array($wrk)) {
            $wrk = implode("||", $wrk);
        }
        if ($wrk != "") {
