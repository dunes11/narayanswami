...
class Locations3 extends DbTable
{
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("locations.*");
    }
    ...
    {
        global $Language;
        if ($pageName == "locations3view") {
            return $Language->phrase("View");
        } elseif ($pageName == "locations3edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "locations3add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "Locations3View";
            case Config("API_ADD_ACTION"):
                return "Locations3Add";
            case Config("API_EDIT_ACTION"):
                return "Locations3Edit";
            case Config("API_DELETE_ACTION"):
                return "Locations3Delete";
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("locations3delete");
        }
    }
